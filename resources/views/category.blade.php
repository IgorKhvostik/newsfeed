    ...
    <section id="contentSection">
        <div class="row">
            <ol class="breadcrumb">
                ...
                <li><a href="{{route ('categoryController',['categoryName'=>$category])}}">category: {{$category}}</a></li>
            </ol>
            <aside class="right_content">
                <div class="single_sidebar">
                    <h2><a href="{{route ('categoryController',['categoryName'=> strtolower($posts->first()->cat_name)])}}"><span>{{$posts->first()->cat_name}}</span></a></h2>
                    <ul class="spost_nav">
